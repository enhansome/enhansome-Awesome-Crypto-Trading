...
* [Freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,012 | 🐛 29 | 🌐 Python | 📅 2026-09-04 - Crypto trading bot written in Python that features backtesting, plotting and money management tools.
...
* [Crypto Trading Bot](https://github.com/Haehnchen/crypto-trading-bot) ⭐ 3,517 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-02 - Cryptocurrency trading bot in Javascript.
* [Gocryptotrader](https://github.com/thrasher-corp/gocryptotrader) ⭐ 3,456 | 🐛 70 | 🌐 Go | 📅 2026-09-04 - A cryptocurrency trading bot and framework supporting multiple exchanges written in Golang.
...
* [Krypto Trading Bot](https://github.com/ctubio/Krypto-trading-bot) ⭐ 3,710 | 🐛 65 | 🌐 C++ | 📅 2024-12-15 - Self-hosted crypto trading bot (automated high frequency market making) in Node.js, Angular, Typescript and C++.
...
* [HummingBot](https://github.com/CoinAlpha/hummingbot) ⭐ 217 | 🐛 9 | 🌐 Python | 📅 2025-05-07 - Hummingbot: a client for crypto market making.
...
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,138 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,480 | 🐛 258 | 🌐 C# | 📅 2026-09-04 - Algorithmic trading engine built for strategy research, backtesting and live trading.
* [Zipline](https://github.com/quantopian/zipline) ⭐ 20,080 | 🐛 370 | 🌐 Python | 📅 2024-02-13 - Zipline is the underlying software for the Quantopian's backtesting engine.
...
* [CCXT](https://github.com/ccxt/ccxt) ⭐ 43,866 | 🐛 848 | 🌐 Python | 📅 2026-09-04 - A JavaScript / Python / PHP cryptocurrency trading unified API interface.
...
* [Awesome Quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,430 | 🐛 63 | 🌐 HTML | 📅 2026-09-04 - A curated list of libraries, packages and resources for Quants.
* [Algo Trading Strategies](https://github.com/je-suis-tm/quant-trading) ⭐ 10,677 | 🐛 4 | 🌐 Python | 📅 2026-06-20 - Some quantitative trading strategies.
...
* [Awesome Quant ML Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 4,014 | 🐛 20 | 📅 2025-05-21 - Quant/Algorithm trading resources with an emphasis on Machine Learning.
