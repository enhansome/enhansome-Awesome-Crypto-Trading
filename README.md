...
* [Freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,297 | 🐛 32 | 🌐 Python | 📅 2026-09-12 - Crypto trading bot written in Python that features backtesting, plotting and money management tools.
...
* [Crypto Trading Bot](https://github.com/Haehnchen/crypto-trading-bot) ⭐ 3,522 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-02 - Cryptocurrency trading bot in Javascript.
* [Gocryptotrader](https://github.com/thrasher-corp/gocryptotrader) ⭐ 3,457 | 🐛 75 | 🌐 Go | 📅 2026-09-11 - A cryptocurrency trading bot and framework supporting multiple exchanges written in Golang.
...
* [Krypto Trading Bot](https://github.com/ctubio/Krypto-trading-bot) ⭐ 3,710 | 🐛 64 | 🌐 C++ | 📅 2024-12-15 - Self-hosted crypto trading bot (automated high frequency market making) in Node.js, Angular, Typescript and C++.
...
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,238 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,600 | 🐛 248 | 🌐 C# | 📅 2026-09-12 - Algorithmic trading engine built for strategy research, backtesting and live trading.
* [Zipline](https://github.com/quantopian/zipline) ⭐ 20,091 | 🐛 368 | 🌐 Python | 📅 2024-02-13 - Zipline is the underlying software for the Quantopian's backtesting engine.
...
* [CCXT](https://github.com/ccxt/ccxt) ⭐ 43,968 | 🐛 827 | 🌐 Rust | 📅 2026-09-12 - A JavaScript / Python / PHP cryptocurrency trading unified API interface.
...
* [Awesome Quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,550 | 🐛 69 | 🌐 HTML | 📅 2026-09-12 - A curated list of libraries, packages and resources for Quants.
* [Algo Trading Strategies](https://github.com/je-suis-tm/quant-trading) ⭐ 10,723 | 🐛 0 | 🌐 Python | 📅 2026-06-20 - Some quantitative trading strategies.
* [Crypto Signals](https://github.com/CryptoSignal/crypto-signal) ⭐ 5,633 | 🐛 56 | 🌐 Python | 📅 2024-07-07 - Command line tool to automate crypto currency TA.
* [Awesome Quant ML Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 4,025 | 🐛 21 | 📅 2025-05-21 - Quant/Algorithm trading resources with an emphasis on Machine Learning.
