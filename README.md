...
* [Freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,448 | 🐛 28 | 🌐 Python | 📅 2026-09-16 - Crypto trading bot written in Python that features backtesting, plotting and money management tools.
...
* [Crypto Trading Bot](https://github.com/Haehnchen/crypto-trading-bot) ⭐ 3,523 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-02 - Cryptocurrency trading bot in Javascript.
* [Gocryptotrader](https://github.com/thrasher-corp/gocryptotrader) ⭐ 3,456 | 🐛 72 | 🌐 Go | 📅 2026-09-16 - A cryptocurrency trading bot and framework supporting multiple exchanges written in Golang.
...
* [Binance Triangle Arbitrage](https://github.com/bmino/binance-triangle-arbitrage) ⭐ 1,166 | 🐛 19 | 🌐 JavaScript | 📅 2022-12-07 - Detects arbitrage opportunities in Binance with triangle arbitrage.
* [Blackbird](https://github.com/butor/blackbird) - Blackbird Bitcoin Arbitrage: a long/short market-neutral strategy.

## Backtesters

* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,259 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,646 | 🐛 254 | 🌐 C# | 📅 2026-09-16 - Algorithmic trading engine built for strategy research, backtesting and live trading.
...
* [CCXT](https://github.com/ccxt/ccxt) ⭐ 44,013 | 🐛 735 | 🌐 Rust | 📅 2026-09-16 - A JavaScript / Python / PHP cryptocurrency trading unified API interface.
...
* [Awesome Quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,624 | 🐛 66 | 🌐 HTML | 📅 2026-09-16 - A curated list of libraries, packages and resources for Quants.
* [Algo Trading Strategies](https://github.com/je-suis-tm/quant-trading) ⭐ 10,741 | 🐛 0 | 🌐 Python | 📅 2026-06-20 - Some quantitative trading strategies.
...
* [Awesome Quant ML Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 4,028 | 🐛 23 | 📅 2025-05-21 - Quant/Algorithm trading resources with an emphasis on Machine Learning.
...
Your contributions are always welcome! Please read the [Contribution Guidelines](https://github.com/SpiralDevelopment/Awesome-Crypto-Trading/blob/master/CONTRIBUTING.md) ⭐ 195 | 🐛 51 | 📅 2020-07-30 before contributing.
