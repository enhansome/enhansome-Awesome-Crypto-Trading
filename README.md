...
* [Freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,168 | 🐛 29 | 🌐 Python | 📅 2026-09-08 - Crypto trading bot written in Python that features backtesting, plotting and money management tools.
...
* [Crypto Trading Bot](https://github.com/Haehnchen/crypto-trading-bot) ⭐ 3,518 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-02 - Cryptocurrency trading bot in Javascript.
* [Gocryptotrader](https://github.com/thrasher-corp/gocryptotrader) ⭐ 3,457 | 🐛 77 | 🌐 Go | 📅 2026-09-07 - A cryptocurrency trading bot and framework supporting multiple exchanges written in Golang.
...
* [Krypto Trading Bot](https://github.com/ctubio/Krypto-trading-bot) ⭐ 3,709 | 🐛 64 | 🌐 C++ | 📅 2024-12-15 - Self-hosted crypto trading bot (automated high frequency market making) in Node.js, Angular, Typescript and C++.
...
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,162 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,541 | 🐛 262 | 🌐 C# | 📅 2026-09-08 - Algorithmic trading engine built for strategy research, backtesting and live trading.
* [Zipline](https://github.com/quantopian/zipline) ⭐ 20,082 | 🐛 370 | 🌐 Python | 📅 2024-02-13 - Zipline is the underlying software for the Quantopian's backtesting engine.
...
* [CCXT](https://github.com/ccxt/ccxt) ⭐ 43,919 | 🐛 844 | 🌐 Rust | 📅 2026-09-08 - A JavaScript / Python / PHP cryptocurrency trading unified API interface.
...
* [Awesome Quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,494 | 🐛 56 | 🌐 HTML | 📅 2026-09-08 - A curated list of libraries, packages and resources for Quants.
* [Algo Trading Strategies](https://github.com/je-suis-tm/quant-trading) ⭐ 10,700 | 🐛 4 | 🌐 Python | 📅 2026-06-20 - Some quantitative trading strategies.
* [Crypto Signals](https://github.com/CryptoSignal/crypto-signal) ⭐ 5,629 | 🐛 56 | 🌐 Python | 📅 2024-07-07 - Command line tool to automate crypto currency TA.
* [Awesome Quant ML Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 4,016 | 🐛 20 | 📅 2025-05-21 - Quant/Algorithm trading resources with an emphasis on Machine Learning.
