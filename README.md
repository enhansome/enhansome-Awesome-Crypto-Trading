...
* [Freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,760 | 🐛 29 | 🌐 Python | 📅 2026-09-24 - Crypto trading bot written in Python that features backtesting, plotting and money management tools.
...
* [Gocryptotrader](https://github.com/thrasher-corp/gocryptotrader) ⭐ 3,459 | 🐛 92 | 🌐 Go | 📅 2026-09-24 - A cryptocurrency trading bot and framework supporting multiple exchanges written in Golang.
...
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,315 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,757 | 🐛 257 | 🌐 C# | 📅 2026-09-24 - Algorithmic trading engine built for strategy research, backtesting and live trading.
* [Zipline](https://github.com/quantopian/zipline) ⭐ 20,115 | 🐛 368 | 🌐 Python | 📅 2024-02-13 - Zipline is the underlying software for the Quantopian's backtesting engine.
...
* [CCXT](https://github.com/ccxt/ccxt) ⭐ 44,136 | 🐛 699 | 🌐 Python | 📅 2026-09-24 - A JavaScript / Python / PHP cryptocurrency trading unified API interface.
...
* [Awesome Quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,731 | 🐛 83 | 🌐 HTML | 📅 2026-09-24 - A curated list of libraries, packages and resources for Quants.
* [Algo Trading Strategies](https://github.com/je-suis-tm/quant-trading) ⭐ 10,768 | 🐛 0 | 🌐 Python | 📅 2026-06-20 - Some quantitative trading strategies.
